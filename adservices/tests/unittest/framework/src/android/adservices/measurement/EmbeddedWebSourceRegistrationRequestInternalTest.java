...
public class EmbeddedWebSourceRegistrationRequestInternalTest {
    ...
    private static final EmbeddedWebSourceRegistrationRequest EXAMPLE_EXTERNAL_SOURCE_REG_REQUEST =
    ...
    public void createFromParcel_basic_success() {
        ...
        verifyExampleRegistrationInternal(
                EmbeddedWebSourceRegistrationRequestInternal.CREATOR.createFromParcel(p));
        p.recycle();
    }
    ...
    private EmbeddedWebSourceRegistrationRequestInternal createExampleRegistrationRequest() {
        return new EmbeddedWebSourceRegistrationRequestInternal.Builder()
                .setSourceRegistrationRequest(EXAMPLE_EXTERNAL_SOURCE_REG_REQUEST)
                .setAttributionSource(CONTEXT.getAttributionSource())
                .build();
    }
    ...
    private void verifyExampleRegistrationInternal(
            EmbeddedWebSourceRegistrationRequestInternal request) {
