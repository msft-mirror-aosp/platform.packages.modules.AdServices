...
public class AppendFactoryTest extends AdServicesUnitTestCase {
    private static final int UNSUPPORTED_VERSION = -1;

    private final AppendFactory mAppendFactory = new AppendFactory();

    @Test
    public void testGetUpdateProcessor_supportedVersion() {
