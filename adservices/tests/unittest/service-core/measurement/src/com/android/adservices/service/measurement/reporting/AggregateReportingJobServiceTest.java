...
public final class AggregateReportingJobServiceTest
        extends MeasurementJobServiceTestCase<AggregateReportingJobService> {
    ...
    @Override
    protected AggregateReportingJobService getSpiedService() {
        return new AggregateReportingJobService();
    }
                ...
                () -> {
                    ...
                    final JobInfo scheduledJobInfo =
                            new JobInfo.Builder(
                                            ...
                                            new ComponentName(
                                                    mSpyContext,
                                                    AggregateReportingJobService.class))
    ...
    public void scheduleIfNeeded_killSwitchOff_previouslyNotExecuted_dontForceSchedule_schedule()
        ...
        runWithMocks(
                () -> {
                    ...
                    // Execute
                    AggregateReportingJobService.scheduleIfNeeded(mMockContext, false);
    ...
    public void testSchedule_jobInfoIsPersisted() throws Exception {
        runWithMocks(
                () -> {
                    ...
                    AggregateReportingJobService.scheduleIfNeeded(mSpyContext, true);
    ...
    private void onStartJob_killSwitchOn() throws Exception {
        ...
        verify(mMockJobScheduler).cancel(eq(MEASUREMENT_AGGREGATE_MAIN_REPORTING_JOB_ID));
    }
    ...
    protected void toggleFeature(boolean value) {
        when(mMockFlags.getMeasurementJobAggregateReportingKillSwitch()).thenReturn(!value);
    }
}
