...
public class InteropTestReader {
    ...
    public String getNextSourceRegistration() {
        ...
        return getRegistration(
                mJson,
                mSourceRegistrationIndexes.remove(mSourceRegistrationIndexes.size() - 1));
    }
    ...
    public String getNextTriggerRegistration() {
        ...
        return getRegistration(
                mJson,
                mTriggerRegistrationIndexes.remove(mTriggerRegistrationIndexes.size() - 1));
    }
    ...
    private void getTriggerRegistrationIndexes() {
        ...
        getRegistrationIndexes(
                ...
                mTriggerRegistrationIndexes);
    }

    private static void getRegistrationIndexes(String json, String headerName,
