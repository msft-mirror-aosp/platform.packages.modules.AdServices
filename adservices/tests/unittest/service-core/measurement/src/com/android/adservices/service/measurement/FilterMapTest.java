...
public final class FilterMapTest extends AdServicesMockitoTestCase {
    ...
    public void serializeAsJson_success() throws Exception {
        ...
        // Execution
        JSONObject jsonObject = expected.serializeAsJson(mMockFlags);
    ...
    @Test
    public void serializeAsJson_lookbackWindowFilterEnabled_success() throws Exception {
    ...
    public void testIsEmpty_lookbackWindowFilterEnabled_empty() {
        ...
        assertThat(filterMap.isEmpty(mMockFlags)).isTrue();
    }
    ...
    public void testIsEmpty_lookbackWindowFilterDisabled_notEmpty() {
        ...
        FilterMap filterMap = new FilterMap();
        filterMap.getAttributionFilterMap().put("a", stringList);
        assertThat(filterMap.isEmpty(mMockFlags)).isFalse();
    }
