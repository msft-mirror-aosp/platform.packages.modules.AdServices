...
public class BetaUxTest {

    private final BetaUx mBetaUx = new BetaUx();
    ...
    public void isEligibleTest_adultUserWithGaFlagOn() {
        ...
        assertThat(mBetaUx.isEligible(mConsentManager, mUxStatesManager)).isFalse();
    }
    ...
    public void isEligibleTest_adultUserWithGaFlagOff() {
        ...
        assertThat(mBetaUx.isEligible(mConsentManager, mUxStatesManager)).isTrue();
    }
