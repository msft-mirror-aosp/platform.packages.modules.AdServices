...
public class RunAdBiddingPerCAProcessReportedStatsTest {
    private static final int NUM_OF_ADS_FOR_BIDDING = 10;
    private static final int RUN_AD_BIDDING_PER_CA_LATENCY_IN_MILLIS = 5;
    private static final int RUN_AD_BIDDING_PER_CA_RESULT_CODE =
            RUN_AD_BIDDING_PER_CAPROCESS_REPORTED__RUN_AD_BIDDING_PER_CA_RESULT_CODE__RUN_AD_SELECTION_STATUS_SUCCESS;
    private static final int GET_BUYER_DECISION_LOGIC_LATENCY_IN_MILLIS = 5;
    private static final int GET_BUYER_DECISION_LOGIC_RESULT_CODE =
            RUN_AD_BIDDING_PER_CAPROCESS_REPORTED__GET_BUYER_DECISION_LOGIC_RESULT_CODE__RUN_AD_SELECTION_STATUS_SUCCESS;
    private static final int BUYER_DECISION_LOGIC_SCRIPT_TYPE =
            RUN_AD_BIDDING_PER_CAPROCESS_REPORTED__BUYER_DECISION_LOGIC_SCRIPT_TYPE__JAVASCRIPT;
    private static final int FETCHED_BUYER_DECISION_LOGIC_SCRIPT_SIZE_IN_BYTES = 10;
    private static final int NUM_OF_KEYS_OF_TRUSTED_BIDDING_SIGNALS = 10;
    private static final int FETCHED_TRUSTED_BIDDING_SIGNALS_DATA_SIZE_IN_BYTES = 10;
    private static final int GET_TRUSTED_BIDDING_SIGNALS_LATENCY_IN_MILLIS = 5;
    private static final int GENERATE_BIDS_LATENCY_IN_MILLIS = 10;
    private static final int RUN_BIDDING_LATENCY_IN_MILLIS = 5;
    private static final int RUN_BIDDING_RESULT_CODE =
            RUN_AD_BIDDING_PER_CAPROCESS_REPORTED__RUN_BIDDING_RESULT_CODE__RUN_AD_SELECTION_STATUS_SUCCESS;
    private static final int GET_TRUSTED_BIDDING_SIGNALS_RESULT_CODE =
