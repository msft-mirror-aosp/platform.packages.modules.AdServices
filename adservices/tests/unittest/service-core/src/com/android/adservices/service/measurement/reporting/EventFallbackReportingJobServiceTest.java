...
public class EventFallbackReportingJobServiceTest {
    ...
    public void onStartJob_killSwitchOn() throws Exception {
        ...
        try {
            ...
            EventFallbackReportingJobService service = new EventFallbackReportingJobService();
    ...
    public void onStartJob_killSwitchOff() throws Exception {
        ...
        try {
            ...
            ExtendedMockito.doReturn(mockDatastoreManager)
                    .when(() -> DatastoreManagerFactory.getDatastoreManager(any()));
            EventFallbackReportingJobService spyService =
                    Mockito.spy(new EventFallbackReportingJobService());
