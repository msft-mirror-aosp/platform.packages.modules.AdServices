...
public class MeasurementDbMigratorV34Test extends MeasurementDbMigratorTestBase {
    @Test
    public void performMigration_v33ToV34WithData_maintainsDataIntegrity() {
        // Setup
        ...
        Map<String, List<ContentValues>> fakeData = createFakeDataSourceV33(source1Id, trigger1Id);
        populateDb(db, fakeData);
        // Execution
        getTestSubject().performMigration(db, 33, 34);
        // Assertion
    ...
    private Map<String, List<ContentValues>> createFakeDataSourceV33(
            String source1Id, String triggerId) {
        Map<String, List<ContentValues>> tableRowsMap = new LinkedHashMap<>();
        // Source Table
        ContentValues source1 = ContentValueFixtures.generateSourceContentValuesV33();
        ...
        ContentValues trigger1 = ContentValueFixtures.generateTriggerContentValuesV33();
        trigger1.put(MeasurementTables.TriggerContract.ID, triggerId);
    ...
    AbstractMeasurementDbMigrator getTestSubject() {
        return new MeasurementDbMigratorV34();
    }
}
