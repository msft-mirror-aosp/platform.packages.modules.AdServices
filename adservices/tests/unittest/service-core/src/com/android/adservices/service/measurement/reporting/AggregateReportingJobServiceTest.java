...
public class AggregateReportingJobServiceTest {
    ...
    public void onStartJob_killSwitchOn() throws Exception {
        ...
        try {
            ...
            AggregateReportingJobService service = new AggregateReportingJobService();
    ...
    public void onStartJob_killSwitchOff() throws Exception {
        ...
        try {
            ...
            ExtendedMockito.doReturn(mockDatastoreManager)
                    .when(() -> DatastoreManagerFactory.getDatastoreManager(any()));
            AggregateReportingJobService spyService =
                    Mockito.spy(new AggregateReportingJobService());
