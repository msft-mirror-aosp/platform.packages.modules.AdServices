...
public final class IsAllowedAttributionAccessCommandTest
        extends ShellCommandTestCase<IsAllowedAttributionAccessCommand> {
    ...
    public void testRun_invalid() throws Exception {
        ...
        runAndExpectInvalidArgument(
                cmd, HELP_IS_ALLOWED_ATTRIBUTION_ACCESS, CMD_IS_ALLOWED_ATTRIBUTION_ACCESS);
        // missing id
        runAndExpectInvalidArgument(
                cmd,
    ...
    public void testRun_valid() throws Exception {
        ...
        Result actualResult = run(cmd, CMD_IS_ALLOWED_ATTRIBUTION_ACCESS, PKG_NAME, ENROLLMENT_ID);
