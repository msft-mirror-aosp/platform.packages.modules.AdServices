...
public class FledgeE2ETest {
    ...
    private static final Flags DEFAULT_FLAGS = new FledgeE2ETestFlags(false);
    ...
    private void initClients(boolean gaUXEnabled) {
        Flags flags = new FledgeE2ETestFlags(gaUXEnabled);
