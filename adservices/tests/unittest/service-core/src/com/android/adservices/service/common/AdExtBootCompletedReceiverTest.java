...
public class AdExtBootCompletedReceiverTest {
    ...
    @Test
    public void testOnReceive_tPlus_flagOnDoNothing() {
        ...
        verify(bootCompletedReceiver, never()).enableAdExtServicesActivities(any());
    }

    @Test
    public void testOnReceive_s_flagsOff_doNothing() {
    ...
    public void testOnReceive_SFlagsOn() {
        ...
        verify(bootCompletedReceiver).enableAdExtServicesActivities(any());
    }
    ...
    @Test
    public void testEnableActivities() throws Exception {
        Assume.assumeTrue(Build.VERSION.SDK_INT == 31 || Build.VERSION.SDK_INT == 32);
        AdExtBootCompletedReceiver bootCompletedReceiver =
                Mockito.spy(new AdExtBootCompletedReceiver());
        ...
        bootCompletedReceiver.enableAdExtServicesActivities(mockContext);
