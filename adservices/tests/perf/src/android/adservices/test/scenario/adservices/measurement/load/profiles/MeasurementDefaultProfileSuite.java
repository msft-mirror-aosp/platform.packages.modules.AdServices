...
import android.adservices.test.longevity.concurrent.StressLowDiskSpace;
import android.adservices.test.longevity.concurrent.StressMemoryUtilization;
...
@SuiteClasses({
    ...
    StressLowDiskSpace.class,
    StressMemoryUtilization.class
})
