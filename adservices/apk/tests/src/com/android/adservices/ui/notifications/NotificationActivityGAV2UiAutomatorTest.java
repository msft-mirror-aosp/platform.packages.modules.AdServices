...
public class NotificationActivityGAV2UiAutomatorTest {
    private static final String NOTIFICATION_PACKAGE =
            "android.adservices.ui.NOTIFICATIONS";
    ...
    private void startActivity(boolean isEUActivity) {
        ...
        sDevice.wait(Until.hasObject(By.pkg(NOTIFICATION_PACKAGE).depth(0)), LAUNCH_TIMEOUT);
    }
