 ...
 */
public class SettingsUxSelectorBlockedTopicsUiAutomatorTest {
    ...
    public void topicBlockUnblockResetTest_betaUxView() throws Exception {
        ...
        if (consentSwitch.isChecked()) {
            ...
            Thread.sleep(LAUNCHER_LAUNCH_TIMEOUT);
        }
        consentSwitch.click();
        Thread.sleep(LAUNCHER_LAUNCH_TIMEOUT);
        ...
        scrollTo(R.string.settingsUI_topics_view_no_topics_text);
        UiObject noTopicsText = getElement(R.string.settingsUI_topics_view_no_topics_text);
        noTopicsText.waitForExists(PRIMITIVE_UI_OBJECTS_LAUNCH_TIMEOUT);
    ...
    public void topicBlockUnblockTest_gaUxView() throws Exception {
        ...
        // "Block" button will not be displayed.
        assertThat(blockTopicButton.exists()).isFalse();
        scrollTo(R.string.settingsUI_topics_view_no_topics_ga_text);
    ...
    private UiObject getElement(int resId) {
        return sDevice.findObject(new UiSelector().textContains(getString(resId)));
    }
