...
public class ReportInteractionRequest {
    ...
    /**
     * Constructs the object wrapping the required arguments needed to report an interaction
     *
     ...
     *     <p>This field will be used to fetch the {@code interactionReportingUri} associated with
     *     the {@code interactionKey} registered in {@code registerAdBeacon} after ad selection.
     *     <p>This field should be an exact match to the {@code interactionKey} registered in {@code
     ...
     * @param interactionData data generated by the caller, and will be attached in a POST request
     *     to the {@code interactionReportingUri} registered in {@code registerAdBeacon}.
     ...
     *
     * <p>This field will be used to fetch the {@code interactionReportingUri} associated with the
     * {@code interactionKey} registered in {@code registerAdBeacon} after ad selection.
     *
     * <p>This field should be an exact match to the {@code interactionKey} registered in {@code
     * registerAdBeacon}. Specific details about {@code registerAdBeacon} can be found at the
     * documentation of {@link AdSelectionManager#reportImpression}
     *
     * <p>The interaction key (when inspecting its byte array with {@link String#getBytes()}) in
     * {@code UTF-8} format should not exceed 40 bytes. Any key exceeding this limit will not be
     * registered during the {@code registerAdBeacon} call.
     *
     * @hide
     */
    @NonNull
     ...
     * AdSelectionManager#reportInteraction}. This data will be attached in a POST request to the
     * {@code interactionReportingUri} registered in {@code registerAdBeacon}.
     *
