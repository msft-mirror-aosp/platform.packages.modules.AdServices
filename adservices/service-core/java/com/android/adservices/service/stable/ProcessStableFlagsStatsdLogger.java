...
public final class ProcessStableFlagsStatsdLogger {
    ...
    void logBatchReadFromDeviceConfigLatencyMicroSecond(long latencyMicroSeconds) {
        AdServicesStatsLog.write(AD_SERVICES_PROCESS_STABLE_FLAGS_REPORTED, latencyMicroSeconds);
    }
