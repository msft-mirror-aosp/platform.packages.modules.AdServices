...
public class PasFirstConsentNotificationChannel implements PrivacySandboxEnrollmentChannel {

    /** Determines if user is eligible for the PAS first time enrollment channel. */
