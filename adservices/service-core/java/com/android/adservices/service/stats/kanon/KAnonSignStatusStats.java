...
public abstract class KAnonSignStatusStats {
    ...
    /** Returns a builder class for {@link Builder} for {@link KAnonSignStatusStats} */
    public static Builder builder() {
        return new AutoValue_KAnonSignStatusStats.Builder()
    ...
    public abstract static class Builder {
        /** Sets the wasSuccessful field for {@link KAnonSignStatusStats}. */
        public abstract Builder setWasSuccessful(boolean wasSuccessful);

        /** Sets the batch size for {@link KAnonSignStatusStats}. */
        public abstract Builder setBatchSize(int batchSize);

        /** Sets the action field for {@link KAnonSignStatusStats}. */
        public abstract Builder setKAnonAction(int kAnonAction);

        /** Sets set batch field for {@link KAnonSignStatusStats}. */
        public abstract Builder setKAnonActionFailureReason(int kAnonActionFailureReason);

        /** Sets the latency for {@link KAnonSignStatusStats}. */
        public abstract Builder setLatencyInMs(int latencyInMs);

        /** Builds and returns a {@link KAnonSignStatusStats} object */
        public abstract KAnonSignStatusStats build();
    }
}
