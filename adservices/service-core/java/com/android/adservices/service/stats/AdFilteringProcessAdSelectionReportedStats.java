...
public abstract class AdFilteringProcessAdSelectionReportedStats {
    ...
    /** Returns the number of custom audiences which are filtered out of bidding. */
    ...
    /** Returns the number of contextual Ads filtered out of bidding because of no Ads. */
    public abstract int getNumOfContextualAdsFilteredOutOfBiddingNoAds();

    /** Returns the total number of contextual Ads before filtering. */
