...
public class ReportImpressionExecutionLoggerNoLoggingImpl
        implements ReportImpressionExecutionLogger {

    /** No logging impl does nothing. */
    @Override
    ...
    /** No logging impl does nothing. */
    @Override
    public void setReportWinJsScriptResultCode(int reportWinJsScriptResultCode) {
        // do nothing
    }

    /** No logging impl does nothing. */
    @Override
    public void setReportResultJsScriptResultCode(int reportResultJsScriptResultCode) {
        // do nothing
    }
