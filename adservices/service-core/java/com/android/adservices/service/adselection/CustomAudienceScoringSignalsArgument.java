 ...
 * scoreAd execution
 */
public class CustomAudienceScoringSignalsArgument {
    ...
    private CustomAudienceScoringSignalsArgument() {}

    /**
     * @return A {@link JSScriptArgument} with the given {@code name} to represent this instance of
     *     {@link CustomAudienceScoringSignalsArgument}
     ...
     *     {@link CustomAudienceScoringSignalsArgument} list
     * @throws JSONException if any of the signals in this class is not valid JSON.
     */
