...
public class AggregateContributionBuckets {
    private Map<String, BucketContributionAndCapacity>
            mBucketNameToAggregateContributionAndCapacity = new HashMap<>();
    ...
    public Optional<Integer> maybeGetBucketContribution(String bucketName) {
        if (mBucketNameToAggregateContributionAndCapacity.containsKey(bucketName)) {
            return Optional.of(
                    mBucketNameToAggregateContributionAndCapacity.get(bucketName)
                            .mAggregateContribution);
        }
        return Optional.empty();
    }
    ...
    public void createCapacityBucket(String bucketName, int maxBudget) {
        ...
        mBucketNameToAggregateContributionAndCapacity.put(
                bucketName, bucketContributionAndCapacity);
    }
    ...
    public boolean equals(Object obj) {
        ...
        AggregateContributionBuckets aggregateContributionBuckets =
                (AggregateContributionBuckets) obj;
