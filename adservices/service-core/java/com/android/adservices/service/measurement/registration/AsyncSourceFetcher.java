...
public class AsyncSourceFetcher {
    ...
    private boolean parseCommonSourceParams(
        ...
        result.setSourceEventId(
                new UnsignedLong(json.getString(SourceHeaderContract.SOURCE_EVENT_ID)));
    ...
    public Optional<List<SourceRegistration>> fetchSource(@NonNull RegistrationRequest request) {
        if (request.getRegistrationType() != RegistrationRequest.REGISTER_SOURCE) {
