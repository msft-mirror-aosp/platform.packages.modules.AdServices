...
public final class AppImportanceFilter {
    ...
    private final AppImportanceStrategy mAppImportanceStrategy;
     ...
     * @param getBindingUidImportanceEnabled whether or the new {@code getBindingUidImportance} API
     *     is enabled.
     */
     ...
     * @param appImportanceStrategy strategy to get app importance.
     */
    @VisibleForTesting
    public AppImportanceFilter(
            ...
            @NonNull Supplier<Integer> importanceThresholdSupplier,
            AppImportanceStrategy appImportanceStrategy) {
        ...
        mAppImportanceStrategy = appImportanceStrategy;
    }
    ...
    public void assertCallerIsInForeground(
        ...
        int importance;
        try {
            importance = mAppImportanceStrategy.getAppImportance(appUid);
        } catch (SecurityException e) {
            LogUtil.e(e, "Failed to call pm.getAppImportance(%d)", appUid);
