...
import static com.android.adservices.service.stats.ShellCommandStats.COMMAND_IS_ALLOWED_ATTRIBUTION_ACCESS;
...
public final class IsAllowedAttributionAccessCommand extends AbstractShellCommand {

    public static final String CMD_IS_ALLOWED_ATTRIBUTION_ACCESS = "is-allowed-attribution-access";

    public static final String HELP_IS_ALLOWED_ATTRIBUTION_ACCESS =
    ...
    public ShellCommandResult run(PrintWriter out, PrintWriter err, String[] args) {
        ...
        boolean isValid = AppManifestConfigHelper.isAllowedAttributionAccess(pkgName, enrollmentId);
        Log.i(
                TAG,
                String.format(
                        "isAllowedAttributionAccess(%s, %s: %b)", pkgName, enrollmentId, isValid));
        out.println(isValid);
        return toShellCommandResult(RESULT_SUCCESS, COMMAND_IS_ALLOWED_ATTRIBUTION_ACCESS);
    }

    @Override
    public String getCommandName() {
        return CMD_IS_ALLOWED_ATTRIBUTION_ACCESS;
    }
