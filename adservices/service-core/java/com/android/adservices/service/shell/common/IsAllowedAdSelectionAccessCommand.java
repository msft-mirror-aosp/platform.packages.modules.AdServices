...
import static com.android.adservices.service.stats.ShellCommandStats.COMMAND_IS_ALLOWED_AD_SELECTION_ACCESS;
...
public final class IsAllowedAdSelectionAccessCommand extends AbstractShellCommand {

    public static final String CMD_IS_ALLOWED_AD_SELECTION_ACCESS =
            "is-allowed-ad-selection-access";

    public static final String HELP_IS_ALLOWED_AD_SELECTION_ACCESS =
    ...
    public ShellCommandResult run(PrintWriter out, PrintWriter err, String[] args) {
        ...
        boolean isValid = AppManifestConfigHelper.isAllowedAdSelectionAccess(pkgName, enrollmentId);
        Log.i(
                TAG,
                String.format(
                        "isAllowedAdSelectionAccess(%s, %s: %b)", pkgName, enrollmentId, isValid));
        out.println(isValid);
        return toShellCommandResult(RESULT_SUCCESS, COMMAND_IS_ALLOWED_AD_SELECTION_ACCESS);
    }

    @Override
    public String getCommandName() {
        return CMD_IS_ALLOWED_AD_SELECTION_ACCESS;
    }
