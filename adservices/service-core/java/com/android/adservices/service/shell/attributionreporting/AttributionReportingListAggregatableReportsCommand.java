...
public class AttributionReportingListAggregatableReportsCommand extends AbstractShellCommand {
    ...
    AttributionReportingListAggregatableReportsCommand(
    ...
    public int getMetricsLoggerCommand() {
        return COMMAND_ATTRIBUTION_REPORTING_LIST_AGGREGATABLE_REPORTS;
    }
    ...
    private ListenableFuture<Optional<List<AggregateReport>>>
            queryForListAggregatableReportsCommand() {
        Log.d(TAG, String.format("Querying for list aggregatable reports"));
