...
public class AttributionReportingListDebugReportsCommand extends AbstractShellCommand {
    ...
    AttributionReportingListDebugReportsCommand(
    ...
    public int getMetricsLoggerCommand() {
        return COMMAND_ATTRIBUTION_REPORTING_LIST_DEBUG_REPORTS;
    }
    ...
    private ListenableFuture<Optional<List<DebugReport>>> queryForListDebugReportsCommand() {
        Log.d(TAG, String.format("Querying for list verbose debug reports"));
