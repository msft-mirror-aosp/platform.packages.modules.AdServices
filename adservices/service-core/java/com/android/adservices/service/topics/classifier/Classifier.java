...
public interface Classifier {
    ...
    /**
     * This method should return a map from the app to the list of its classification topics.
     * If there are no classifications for the app, an empty list of topic should be assigned for
     * that app.
     *
     * @param apps The set of apps
     * @return {@code appClassificationTopicsMap = Map<App, List<TopicId>>}
     */
    @NonNull
    Map<String, List<Integer>> classify(@NonNull Set<String> apps);
     ...
     *
     * The result of this function is a list of numberOfTopTopics + numberOfRandomTopics
     * topics.
     *
