...
interface ISdkSandboxManager {
    ...
    */
    ...
    oneway void loadSdk(in String callingPackageName, in IBinder appProcessToken, in String sdkName, in SandboxLatencyInfo sandboxLatencyInfo, long timeAppCalledSystemServer, in Bundle params, in ILoadSdkCallback callback);
