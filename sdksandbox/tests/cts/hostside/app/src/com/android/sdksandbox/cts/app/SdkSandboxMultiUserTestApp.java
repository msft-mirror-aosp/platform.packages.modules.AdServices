...
public class SdkSandboxMultiUserTestApp {

    private static final String SDK_NAME = "com.android.sdksandbox.cts.provider.multiusertest";
    ...
    @Test
    public void testAppCanLoadSdk() throws Exception {
