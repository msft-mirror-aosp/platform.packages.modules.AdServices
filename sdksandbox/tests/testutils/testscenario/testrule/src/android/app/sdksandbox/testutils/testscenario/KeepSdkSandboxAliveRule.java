            ...
            public void evaluate() throws Throwable {
                try (ActivityScenario scenario =
                    ...
                    try {
                        ...
                        // {@link FakeLoadSdkCallback} will throw this exception if we timeout
                        // waiting for a response. In which case, we should _not_ attempt to
                        // retrieve the error code because the getLoadSdkErrorCode call will likely
                        // fail as the callback would not have resolved yet.
                        throw e;
                    } catch (Exception e) {
