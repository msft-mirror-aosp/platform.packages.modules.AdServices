...
// TODO(b/340974756): add unit tests
/**
 * Superclass for all host-side tests, it contains just the bare minimum setup needed by all tests
 * (like implementing {@link IDeviceTest}).
 */
