...
public final class HostSideDeviceConfigShellCmdImplIntegrationTest
        extends DeviceConfigShellCmdImplIntegrationTestCase implements IDeviceTest {
    ...
    public ITestDevice getDevice() {
        return TestDeviceHelper.getTestDevice();
    }

    @Override
    protected AbstractSdkLevelSupportedRule getSdkLevelSupportRule() {
        return HostSideSdkLevelSupportRule.forAnyLevel();
    }

    @Override
    protected DeviceGateway getDeviceGateway() {
        return new HostSideDeviceGateway();
    }
}
